...
function GridBackground() {
  ...
  return (
    <motion.div
      aria-hidden
      className="hidden mix-blend-exclusion dark:mix-blend-normal xl:block pointer-events-none absolute inset-0 -z-50 overflow-hidden bg-[size:103%_103%] bg-no-repeat object-fill"
      style={{
        backgroundImage: `url("bg/future-grid.webp")`,
